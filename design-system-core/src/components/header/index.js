...
import menu from "design-assets/dist/assets/icons/menu";
import close from "design-assets/dist/assets/icons/close";
import "../icon";
...
export default class DscHeader extends LitElement {
  ...
  render() {
    return html`
      ...
      >
        <div class="header-brand">${createSvgElement(Brand)}</div>
